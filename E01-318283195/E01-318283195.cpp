...
void generateRandomColor(float& red, float& green, float& blue) {
	int colorIndex = rand() % numColors;
	red = colors[colorIndex][0];
...
int main()
{
	...
	//CREAR VENTANA
	GLFWwindow *mainWindow = glfwCreateWindow(WIDTH, HEIGHT, "Diego Emir", NULL, NULL);
 ...
 //Crear tríangulo
	...
	while (!glfwWindowShouldClose(mainWindow)) {
		...
		glDrawArrays(GL_TRIANGLES,0,70);
		glBindVertexArray(0);
