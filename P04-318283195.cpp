...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//model = glm::rotate(model, glm::radians(90.0f), { 1.0f, 0.0f, 0.0f }); // Asegúrate de que este ángulo sea adecuado
		////model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 1.0f, 0.0f)); // Rotación alrededor del eje Y
		//model = glm::rotate(model, glm::radians(mainWindow.getrotaz1()), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//model = glm::rotate(model, glm::radians(mainWindow.getrotaz2()), glm::vec3(0.0f, 1.0f, 0.0f));
		//model = glm::scale(model, { 1.2f, 0.8f, 1.2f });
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//color = glm::vec3(0.5f, 0.5f, 0.5f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//model = glm::translate(model, { 2.3f, -0.75f, -1.5f });
		//model = glm::rotate(model, glm::radians(90.0f), { 1.0f, 0.0f, 0.0f });
		//model = glm::rotate(model, glm::radians(mainWindow.getrotaz3()), glm::vec3(0.0f, 1.0f, 0.0f));
		//model = glm::scale(model, { 1.2f, 0.8f, 1.2f });
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//color = glm::vec3(0.5f, 0.5f, 0.5f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//model = glm::translate(model, { -2.3f, -0.75f, -1.5f });
		//model = glm::rotate(model, glm::radians(90.0f), { 1.0f, 0.0f, 0.0f });
		//model = glm::rotate(model, glm::radians(mainWindow.getrotaz4()), glm::vec3(0.0f, 1.0f, 0.0f));
		//model = glm::scale(model, { 1.2f, 0.8f, 1.2f });
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//color = glm::vec3(0.5f, 0.5f, 0.5f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//Oreja1
		model = modelauxOrejas;
		model = glm::translate(model, glm::vec3(-3.0f, 3.5f, 2.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaoreja1()), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = modelBaseAux;
		model = glm::translate(model, glm::vec3(-3.0f, 3.5f, -2.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaoreja2()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		modelauxOrejas = model;
		color = glm::vec3(1.0f, 0.8f, 1.0f);
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		...
		model = modelBaseAux;
		model = glm::translate(model, glm::vec3(3.0f, -3.0f, 2.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz2()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(-15.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 9.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz3()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = modelBaseAux;
		model = glm::translate(model, glm::vec3(-3.0f, -3.0f, -2.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz4()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(15.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(-60.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(-75.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux = model;
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 9.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz5()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(100.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelBaseAux;
		model = glm::translate(model, glm::vec3(3.0f, -3.0f, -2.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz6()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(-15.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(-60.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(-20.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux = model;
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 9.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz7()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
