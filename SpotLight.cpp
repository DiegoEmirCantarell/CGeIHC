...
SpotLight::SpotLight() : PointLight(), isActive(true) // Inicializa isActive en true
{
...
SpotLight::SpotLight(GLfloat red, GLfloat green, GLfloat blue,
    ...
    isActive(true) // Inicializa isActive en true
{
...
void SpotLight::UseLight(GLuint ambientIntensityLocation, GLuint ambientColourLocation,
    ...
    GLuint edgeLocation)
{
    if (isActive) // Solo usa la luz si está activa
    {
...
void SpotLight::Disable() // Método para desactivar la luz
{
    isActive = false;
}

void SpotLight::Enable() // Método para activar la luz
{
    isActive = true;
}
