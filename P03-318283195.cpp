...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Piramide Negra
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(3.6f, 0.0f, 0.3f));
		...
		meshList[1]->RenderMesh(); //dibuja cubo,,pirámide triangular y pirámide base cuadrangular
		...
		for (int i = 0; i < 3; i++)
		{
			for (int j = 0; j < 3 - i; j++) 
			{
				...
				{
					float x = i + (0.9f * i) + (0.9f * j) + (0.9f * k);
					float y = j + (0.6f * j);    
					float z = k + (0.7f * k) + (0.7f * j); 
					...
					{
						glm::mat4 modelInner = model;
						modelInner = glm::scale(modelInner, glm::vec3(0.8f, 0.8f, 0.8f));
						...
						case 1:
							if (k == 0)
							{
								translation = glm::vec3(0.0f, 0.15f, -0.02f);
						...
						case 2:
							if (j == 0)
							{
								translation = glm::vec3(0.0f, -0.02f, 0.15f);
						...
						case 3:
							if (i == 0)
							{
								translation = glm::vec3(-0.1f, 0.15f, 0.2f);
						...
						case 4:
							...
							{
								translation = glm::vec3(0.15f, 0.15f, 0.2f);
								color = glm::vec3(1.0f, 0.0f, 1.0f);
							}
							break;
						}
						modelInner = glm::translate(modelInner, translation);
