...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_T)
	{
		theWindow->rotaz1 += 10.0;
	}
	if (key == GLFW_KEY_Y)
	{
		theWindow->rotaz2 += 10.0;
	}
	if (key == GLFW_KEY_U)
	{
		theWindow->rotaz3 += 10.0;
	}
	if (key == GLFW_KEY_I)
	{
		theWindow->rotaz4 += 10.0;
	}
	if (key == GLFW_KEY_O)
	{
		theWindow->rotaz5 += 10.0;
	}
	if (key == GLFW_KEY_P)
	{
		theWindow->rotaz6 += 10.0;
	}
	if (key == GLFW_KEY_M)
	{
		theWindow->rotaz7 += 10.0;
	}
	if (key == GLFW_KEY_B)
	{
		theWindow->rotaoreja1 += 10.0;
	}
	if (key == GLFW_KEY_N)
	{
		theWindow->rotaoreja2 += 10.0;
	}
	if (key == GLFW_KEY_F)
	{
